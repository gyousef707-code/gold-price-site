...
export const DICT = {
  ar: {
    ...
    'calc.zakatNoNisab': 'الوزن أقل من النصاب — مالهوش نصيب في دفع الزكاة',
    'calc.zakatNisabHint': 'نصاب زكاة الذهب 85 جرام من الذهب الخالص (عيار 24). لو ذهبك عيار أقل، الوزن المطلوب للنصاب بيزيد بنفس نسبة النقاء.',
  ...
  en: {
    ...
    'calc.zakatNoNisab': 'Weight is below the nisab — no zakat is due',
    'calc.zakatNisabHint': 'Gold zakat nisab is 85 g of pure (24K) gold. For a lower karat, the equivalent weight is higher based on purity.',
    'calc.coin': 'Coin',
    'calc.qty': 'Quantity',
